...
def load_amulets(apps, schema_editor):
	...
	dmg = AmuletAffix.objects.get(affix='dmg')
	mainStat = AmuletAffix.objects.get(affix='mainStat')
	dext = AmuletAffix.objects.get(affix='dext')
	inte = AmuletAffix.objects.get(affix='inte')
	stre = AmuletAffix.objects.get(affix='stre')
	vita = AmuletAffix.objects.get(affix='vita')

	eleDmg = AmuletAffix.objects.get(affix='eleDmg')
	physDmg = AmuletAffix.objects.get(affix='physDmg')
	coldDmg = AmuletAffix.objects.get(affix='coldDmg')
	fireDmg = AmuletAffix.objects.get(affix='fireDmg')
	lightDmg = AmuletAffix.objects.get(affix='lightDmg')
	poisDmg = AmuletAffix.objects.get(affix='poisDmg')
	arcaneDmg = AmuletAffix.objects.get(affix='arcaneDmg')
	holyDmg = AmuletAffix.objects.get(affix='holyDmg')

	life = AmuletAffix.objects.get(affix='life')
	armor = AmuletAffix.objects.get(affix='armor')
	allRes = AmuletAffix.objects.get(affix='allRes')
	lps = AmuletAffix.objects.get(affix='lps')
	lph = AmuletAffix.objects.get(affix='lph')

	ias = AmuletAffix.objects.get(affix='ias')
	chc = AmuletAffix.objects.get(affix='chc')
	chd = AmuletAffix.objects.get(affix='chd')

	cdr = AmuletAffix.objects.get(affix='cdr')
	rcr = AmuletAffix.objects.get(affix='rcr')
	sockets = AmuletAffix.objects.get(affix='sockets')


	eleRes = AmuletAffix.objects.get(affix='eleRes')
	physRes = AmuletAffix.objects.get(affix='physRes')
	coldRes = AmuletAffix.objects.get(affix='coldRes')
	fireRes = AmuletAffix.objects.get(affix='fireRes')
	lightRes = AmuletAffix.objects.get(affix='lightRes')
	poisRes = AmuletAffix.objects.get(affix='poisRes')
	arcaneRes = AmuletAffix.objects.get(affix='arcaneRes')

	reducedRangeDmg = AmuletAffix.objects.get(affix='reducedRangeDmg')
	reducedMeleeDmg = AmuletAffix.objects.get(affix='reducedMeleeDmg')

	blindChance = AmuletAffix.objects.get(affix='blindChance')

	ccReduction = AmuletAffix.objects.get(affix='ccReduction')
	thorns = AmuletAffix.objects.get(affix='thorns')
	itemHealing = AmuletAffix.objects.get(affix='itemHealing')
	lpk = AmuletAffix.objects.get(affix='lpk')
	
	killExp = AmuletAffix.objects.get(affix='killExp')
	extraGold = AmuletAffix.objects.get(affix='extraGold')
