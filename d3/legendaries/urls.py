...
from .views import GroupWeaponView, SlotWeaponView, CategoryWeaponView, GroupArmorView, SlotArmorView, CategoryArmorView, GroupAccessoryView, SlotAccessoryView, SingleLegendaryView
...
urlpatterns = [
	...
	# url(r'^(?P<name_slug>[\w\-]+)/$', SingleLegView.as_view(), name='single-leg'),
